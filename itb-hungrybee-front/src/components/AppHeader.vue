    ...
    <div class="container">
      <div class="header__wrapper">
        ...
        <div class="header__menu">
          ...
          <router-link v-if="isLoggedIn && carCount > 0" class="header__menu-card" to="/cart">
            <img src="@/assets/header/shopping bag.svg" />
            <span class="header__menu-counter">{{ carCount }}</span>
          </router-link>

          <div v-else-if="isLoggedIn" class="header__menu-card">
            <img src="@/assets/header/shopping bag.svg" />
            <span class="header__menu-counter">{{ carCount }}</span>
          </div>
